...
qemu_target_list="arc64 arc32 arc"

#i386 i486 alpha arm armeb sparc sparc32plus sparc64 \
...
arc_mask='\xff\xff\xff\xff\xff\xfe\xfe\x00\xff\xff\xff\xff\xff\xff\xff\xff\xfe\xff\xff\xff'
arc_family=arc
